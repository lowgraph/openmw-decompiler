...
--
-- Records are keyed by a string id, not a number: core.magic.EFFECT_TYPE.WaterBreathing
-- is "waterbreathing", whatever its doc annotation says. Iterating with pairs yields
-- positions, which are meaningless, so each effect is published under its own id and
-- name and the join happens on the reading side.
